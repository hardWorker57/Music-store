...
const Services = () => {
  ...
  useEffect(() => {
    ...
    gsap.fromTo('.services_item', {opacity: 0, y: 80}, {opacity: 1, y:0, stagger: 0.3, delay: .7, duration: 1, scrollTrigger: {trigger: '.services_item'}})
  ...
  return (
    <div className="max-w-screen-xl mx-auto pb-28">
      ...
      <div className="services flex justify-between gap-7">
        <div className="services_item bg-slate-400 max-w-sm rounded-3xl overflow-hidden">
          <div className="img">
